...
Constant PRINTNUMBER = false;
Constant MENUABOUTGAME = 347;
Constant MENUCREDITS = 349;
...
Class HintTopic
        ...
        with    printsn [; print (name) self;],
                ...
                select [ o i j iTest;
                         iTest = 0;
                         if (child(self) == MENUABOUTGAME) iTest++;
                         if (child(self) == MENUCREDITS) iTest++;
...
!                        CenterU(self.title_bar,1);
                         ...
                         style bold;
                         CenterU(self.printsn,1);
                         style roman; style reverse;

                         ! Test Variable
                         if (PRINTNUMBER) print child(self);
